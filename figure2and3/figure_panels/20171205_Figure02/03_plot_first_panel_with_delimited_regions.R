...
# Need to set the lower panel to negative values... 
df$Substitutions[df$Panel=="lower"] <- -df$Substitutions[df$Panel=="lower"]
...
pdf('03_pb_il_panel_delimited.pdf', height=3, width=3.5)
plot(pl)
dev.off()
